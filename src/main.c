...
/*   Updated: 2024/09/24 14:51:24 by jmafueni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**create_sample_map(void)
{
	...
	map[1] = ft_strdup("1P00000000000101");
	map[2] = ft_strdup("1C01110000C00101");
	map[3] = ft_strdup("1111E00000001101");
	map[4] = ft_strdup("1111111111111111");
	map[5] = NULL; // Terminate with NULL for easier handling
